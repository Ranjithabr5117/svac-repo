...
<p>
	...
	<table id="results" class="tab" border="1" cellpadding="5px" cellspacing="4px" width="600px">
		...
		<tr>
			...
			<font color="#ffffff" style="font-style: bold" size="5">Attribute_2 Details</font>
			</td>
		...
		<tr>
			<th><font color="#ffffff" style="font-style: bold" size="4">Attribute_2 ID</font></th>
			<th><font color="#ffffff" style="font-style: bold" size="4">Attribute_2 Name</font></th>
		</tr>
...
%>
			<tr align="center">
						...
						<td><font color="#ffffff" style="font-style: italic" size="3"><%=designationName%></font></td>
			</tr>
<%
		}
