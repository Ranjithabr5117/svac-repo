...
<div id="a2" style="position:absolute;top:50px;left:50px" class="c">
	...
	<table id="login" align="center">
	    ...
	    <h1 align="center"><font color="#FFFFFF" style="font-style: bold" size="5">Upload Your File To Cloud</font></h1>
		...
		<tr align="center">
			<td align="center" colspan="3">
			<button class="button button5" type="submit"  value="Upload File" >Upload File</button>
...
%>
	...
	<table id="login" align="center">
		...
		<tr  bgcolor="#A9D2FB" align="center">
		    ...
		    <td><font color="white" size="4px"><%= username %></font> </td>
