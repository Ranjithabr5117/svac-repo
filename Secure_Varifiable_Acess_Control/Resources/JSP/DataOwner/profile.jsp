...
%>
			...
			<button class="button button5" type="submit" >	<a class="gradientbuttons" href="<%=request.getContextPath() %>/EditOwnerProfile?no=1">Edit Profile</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
			<button class="button button5" type="submit" >	<a class="gradientbuttons" href="<%=request.getContextPath() %>/ChangeOwnerPassword?no=1&id=<%=id %>" target="myIframe">Change Password</a></button>
			</div>
			<br>
				...
				<p>
					...
					<table>
							<tr>
									...
									<font color="#ffffff" style="font-style: bold" size="5">Data Owner Profile Details</font>
									</td>
							...
							<tr>
									...
									<td>:</td>
									<td><font color="#ffffff" style="font-style: italic;" size="3"> <%=phone %></font></td>
							</tr>
